/*
    virtual ->
    - grandchild derived classes inherit only one copy of base class's member variables 
*/
...
class Animal {
    ...
    // constructor that accepts species name for initialization
...
class Bat : public WingedAnimal, public Mammal {
    ...
    // Bat constructor
    // Animal's constructor will only be called once
